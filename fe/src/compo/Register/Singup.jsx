    ...
    <div>
      ...
      <Box p={8} display="flex" flexDirection="column" alignItems="center">
        <img
          ...
          src="https://test-foodcraft.ekfccloud.ae/foodcraft/assets/img/fc-test-logo-l.png"
          alt=""
        />
        <p className="font-bold opacity-50 text-lg mb-10 text-center">
          Experience the delightful food experience with FoodCraft.
        </p>
        <Formik
        ...
        >
          {(formikProps) => (
            <Form className="w-full">
              ...
              Sign in to the Food Craft  for experience the delightful food experience .
              </p>
              <Button
                className="w-full"
                mt={4}
